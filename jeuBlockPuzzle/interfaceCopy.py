...
class Jeu() : 
    ...
    def __init__(self,n):
        ...
        self.entrer = pygame.Rect((400,550,100,70))
        self.clique = False 
        self.perd = pygame.Rect((250,150,300,150))
...
#affiche le score      
    ...
    def perdu(self):
        ...
        perdu = arial_font.render("Vous avez perdu ", False, (0,0,0))
        pygame.draw.rect(self.screen,(190,50,67),self.perd)
        self.screen.blit(perdu, self.perd)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if self.entrer.collidepoint(event.pos):
                         Jeu(self.n).fonction_principale()
